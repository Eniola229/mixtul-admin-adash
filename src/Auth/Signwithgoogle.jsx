...
const Signwithgoogle = () => {
   const handleSignup = async () => {
    try {
      ...
      // Access additional user information from Google provider
      ...
      // You can add additional logic after successful signup
    } catch (error) {
  ...
  return (
    <div>
      <Button 
      sx={{ background:"black", width:"100%", mt: 3, mb: 2, color:"white",  '&:hover': {
